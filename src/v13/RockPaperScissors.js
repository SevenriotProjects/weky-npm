...
const db = new Datastore({ filename: 'rpsdb', autoload: true });
						...
						if (challengerChose && opponentChose === true) {
							...
							if (challengerChoice === opponentChoice) {
								...
								if (options.returnWinner) {
									...
									db.insert({ _id: `RockPaperScissors_${options.message.guild.id}_${options.gameID}`, opponentId: options.opponent.id });
								...
								if (options.returnWinner) {
									...
									db.insert({ _id: `RockPaperScissors_${options.message.guild.id}_${options.gameID}`, authorId: options.message.author.id });
